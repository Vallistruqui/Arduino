...
tita1 = atan(rq(2)/rq(1)); %Este ángulo debe ser igual al ángulo ingresado en el vector Q al principio
...
a=[tita1g tita2g*(-1) tita3g+37 tita4g-7 tita5g+100];
write(s,a,'char')
